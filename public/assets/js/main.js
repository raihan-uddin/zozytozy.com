...
(function ($) {
    ...
    $(".bb-popnews-close").click(() => {
        ...
        localStorage.setItem('newsletterClosed', 'true'); // Store that the popup has been closed
    });
    ...
    $("body").on("click", ".add-to-cart", function () {
        ...
        // check if size-variant is present
    ...
    function addItemToCart(product, qty, price, url, sizeVariant, colorVariant) {  
        ...
        let variant = null;
        if (sizeVariant && colorVariant) {
            const selectedVariant = parseFloat(sizeVariant.price) >= parseFloat(colorVariant.price)
                ? sizeVariant
                : colorVariant;
            variant = {
                ...
                price: Math.max(parseFloat(sizeVariant.price), parseFloat(colorVariant.price)),
            ...
            variant = {
                ...
                weight: sizeVariant.weight,
                weight_unit: sizeVariant.weight_unit,
            }
            ...
            variant = {
                ...
                weight: colorVariant.weight,
                weight_unit: colorVariant.weight_unit,
            }
        }
