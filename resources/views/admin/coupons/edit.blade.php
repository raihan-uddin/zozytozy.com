                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-4 p-4 bg-green-50 border border-green-300 rounded-lg shadow-md">
                        <div class="flex items-center">
                            ...
                            <span class="ml-3 font-medium text-green-800">{{ __('Coupon updated successfully!') }}</span>
                        </div>
                    ...
                    <form action="{{ route('coupons.update', $coupon->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <x-input id="value" class="block mt-1 w-full" type="number" name="value"
                        ...
                        <div class="mb-4">
                            ...
                            <x-textarea id="description" class="block mt-1 w-full" name="description">{{ old('description', $coupon->description) }}</x-textarea>
                            @error('description')
                                <span class="text-red-600 text-sm" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
