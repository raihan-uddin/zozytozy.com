            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" target="_blank" title="Browse Home Page">
                        <img src="{{ asset('images/logos/logo.png') }}" alt="logo" class=" fill-current text-gray-800 h-16" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    :active="request()->routeIs('settings.*') || request()->routeIs('countries.*') || request()->routeIs('states.*') || request()->routeIs('phpinfo')"
                    >
                        {{ __('Settings') }}
                    </x-nav-link>

                    <x-nav-link :href="route('products.index')"
                        :active="request()->routeIs('categories.*') || request()->routeIs('tags.*') || request()->routeIs('products.*') || request()->routeIs('vendors.*') "
                    >
                        {{ __('Products') }}
                    </x-nav-link>
